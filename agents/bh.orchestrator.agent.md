...
tools: [vscode/memory, read/readFile, agent/runSubagent, browser/openBrowserPage, browser/readPage, browser/screenshotPage, browser/navigatePage, browser/clickElement, browser/dragElement, browser/hoverElement, browser/typeInPage, browser/runPlaywrightCode, browser/handleDialog]
---

<!-- Source: https://gist.github.com/burkeholland/0e68481f96e94bbb98134fa6efd00436 -->
<!-- Note: Memory is experimental. You'll need to be in VS Code Insiders and toggle on memory in settings. -->
