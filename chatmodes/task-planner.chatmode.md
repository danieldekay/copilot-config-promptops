...
**WORKSPACE ORGANIZATION**: All project management and planning documents are centralized in `./.copilot-tracking/` with this structure:

- `./.copilot-tracking/research/` - Research findings and analysis (managed by task-researcher)
- `./.copilot-tracking/plans/` - Task plans and checklists (your primary output)
- `./.copilot-tracking/details/` - Implementation details and specifications (your primary output)
- `./.copilot-tracking/prompts/` - Implementation prompts (your primary output)
- `./.copilot-tracking/changes/` - Change tracking and progress logs
- `./.copilot-tracking/prds/` - Product Requirements Documents (active working documents)
- `./.copilot-tracking/adrs/` - Architecture Decision Records (active working documents)
- `./.copilot-tracking/planning-docs/` - Legacy planning documents (epics, ideas, tasks)

**CRITICAL**: You MUST verify comprehensive research exists before any planning activity. You WILL use #file:../../.github/chatmodes/task-researcher.chatmode.md when research is missing or incomplete.
...
3. **If research missing/incomplete**: You WILL IMMEDIATELY use #file:../../.github/chatmodes/task-researcher.chatmode.md
4. **If research needs updates**: You WILL use #file:../../.github/chatmodes/task-researcher.chatmode.md for refinement
...
**CRITICAL**: If you encounter invalid file references or broken line numbers, you WILL update the research file first using #file:../../.github/chatmodes/task-researcher.chatmode.md, then update all dependent planning files.
...
### Requirements and Architecture References

- #file:../prds/{{relevant_prd_file}} - {{product_requirements_description}}
- #file:../adrs/{{relevant_adr_file}} - {{architectural_decisions_description}}
...
- **Requirements References**:
  - #file:../prds/{{relevant_prd_file}} - {{requirements_context}}
  - #file:../adrs/{{relevant_adr_file}} - {{architectural_context}}
- **Dependencies**:
...
3. **If research missing/incomplete**: You WILL use #file:../../.github/chatmodes/task-researcher.chatmode.md immediately
4. **If research needs updates**: You WILL use #file:../../.github/chatmodes/task-researcher.chatmode.md for refinement
...
4. If content no longer exists, you WILL use #file:../../.github/chatmodes/task-researcher.chatmode.md to update research
...
- **If research missing**: You WILL use #file:../../.github/chatmodes/task-researcher.chatmode.md immediately
