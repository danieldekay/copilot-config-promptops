...
- `./.copilot-tracking/research/` - Research findings and analysis (your primary workspace)
- `./.copilot-tracking/plans/` - Task plans and checklists
- `./.copilot-tracking/details/` - Implementation details and specifications
- `./.copilot-tracking/prompts/` - Implementation prompts
...
- `.copilot-tracking/prds/` - Product requirements and feature specifications
- `.copilot-tracking/adrs/` - Architectural decisions and technical constraints
...
- #file:../.copilot-tracking/prds/{{relevant_prd_file}}
  - {{requirements_and_constraints_identified}}

### Architecture Decision Analysis

- #file:../.copilot-tracking/adrs/{{relevant_adr_file}}
  - {{architectural_constraints_and_decisions}}
