...
### Step 1: GATHER → `dk.deep-research.gather`
...
### Step 2: PROCESS → `dk.deep-research.process`
...
### Step 2b: BOOKMARK → `dk.deep-research.bookmark`
...
### Step 3: EXTRACT → `dk.deep-research.extract`
...
### Step 4: EVALUATE → `dk.deep-research.evaluate`
...
### Step 5: SYNTHESIZE → `dk.deep-research.synthesize`
...
### Step 5b: BOOKMARK ENRICHMENT → `dk.deep-research.bookmark`
